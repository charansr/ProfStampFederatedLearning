...
def main(cfg: DictConfig):
    ...
    results_path = str(Path(save_path)) + "/" + getOutputFileName(cfg.model, cfg.attack_round, cfg.max_attack_ratio, cfg.weight_attack_ratio)
    ...
    config = {"model": cfg.model, "attack_mode": cfg.attack_round, "client_attack_ratio": cfg.max_attack_ratio, "weight_attack_ratio": cfg.weight_attack_ratio}
...
def getOutputFileName(model: str, attack_round: str, attack_ratio: float, weight_attack_ratio: float) -> str:
    return model + "_" + attack_round + "_" + str(int(attack_ratio * 100)) + "_" + str(int(weight_attack_ratio * 100)) + ".pkl"
